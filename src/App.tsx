            ...
            <div className='mt-4 border rounded p-4 bg-slate-50'>
              ...
              <div className='p-3 bg-white rounded shadow-sm mt-3'>
                <div className="text-sm flex flex-col mt-2 space-y-2">
                  ...
                  {/* Contact info */}
                  <div className='grid grid-rows-[30px_1fr] md:grid-cols-[160px_1fr] gap-0 md:gap-4 items-start border-b-2 border-b-gray-200 p-3'>
                  ...
                  {/* File */}
                  <div className='grid grid-rows-[30px_1fr] md:grid-cols-[160px_1fr] gap-0 md:gap-4 items-start p-3'>
              ...
              <div className='p-3 bg-white rounded shadow-sm mt-3'>
                <div className="text-sm flex flex-col mt-2 space-y-2">
                  ...
                  {/* Job Level Match */}
                  <div className='grid grid-rows-[34px_1fr] gap-0 md:grid-cols-[200px_1fr] md:gap-4 items-start border-b-2 border-b-gray-200 p-3'>
                  ...
                  {/* Measurable Results */}
                  <div className='grid grid-rows-[34px_1fr] gap-0 md:grid-cols-[200px_1fr] items-start border-b-2 border-b-gray-200 p-3'>
                  ...
                  {/* Web Presence */}
                  <div className='grid grid-rows-[34px_1fr] gap-0 md:grid-cols-[200px_1fr] items-start p-3'>
